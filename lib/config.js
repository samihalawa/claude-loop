...
class Config {
    ...
    getEnvInt(key, defaultValue) {
        ...
        if (isNaN(parsed)) {
            console.warn(`Warning: Invalid integer for ${key}: "${value}". Using default: ${defaultValue}`);
            return defaultValue;
        }
        return parsed;
    }
    ...
    getEnvBool(key, defaultValue) {
        ...
        console.warn(`Warning: Invalid boolean for ${key}: "${value}". Using default: ${defaultValue}`);
        return defaultValue;
    }
    ...
    getEnvOctal(key, defaultValue) {
        ...
        if (isNaN(parsed)) {
            console.warn(`Warning: Invalid octal for ${key}: "${value}". Using default: ${defaultValue.toString(8)}`);
            return defaultValue;
        }
        return parsed;
    }
