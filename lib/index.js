...
const ClaudeLoopEngine = require('./claude-loop-engine');
...
class ClaudeLoop {
  ...
  async debug() {
    console.log(chalk.cyan.bold('\n🤖 Claude Loop - Real Iterative Repository Debugger\n'));
    
    // Check if using new engine mode
    if (this.options.engine === 'iterative' || !this.options.legacy) {
      // Use the real Claude Loop Engine
    ...
    // Legacy mode (old static approach)
    console.log(chalk.yellow('Using legacy static mode. For real iterative debugging, use: claude-loop debug --engine iterative\n'));
